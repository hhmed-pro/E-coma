...
export function TopProductsTable({ products = DEFAULT_PRODUCTS }: TopProductsTableProps) {
                ...
                <div className="space-y-4">
                    {products.map((product, index) => (
                        ...
                        >
                            {/* Rank */}
                            <span
                                className={`w-8 h-8 flex items-center justify-center rounded-full text-sm font-bold ${index === 0
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    <div
                                        className="h-1.5 bg-indigo-100 dark:bg-indigo-900 rounded-full overflow-hidden flex-1 max-w-24"
                                    >
                                        <motion.div
