...
export const chartColors = {
    ...
    // Chart-specific semantic colors - Anthropic palette
    success: "#788c5d",  // Anthropic Green
    warning: "#d97757",  // Anthropic Orange
    error: "#c75050",    // Muted red
    info: "#6a9bcc",     // Anthropic Blue

    // Extended palette (Anthropic brand colors with harmonious additions)
    palette: [
        "#d97757", // Orange (primary accent)
        "#6a9bcc", // Blue (secondary accent)
        "#788c5d", // Green (tertiary accent)
        "#b0aea5", // Mid Gray
        "#a67c52", // Warm brown
        "#7a8b99", // Slate blue
        "#9c8b7a", // Taupe
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {showTrend && change !== null && (
                                    <span className={cn(
                                        ...
                                        change > 0 ? "text-[#788c5d]" : change < 0 ? "text-[#c75050]" : "text-muted-foreground"
                                    )}>
...
export function Sparkline({
    ...
    return (
        <div className={cn("flex items-center gap-2", className)}>
            ...
            {showTrend && (
                <div className={cn("flex items-center gap-0.5 text-xs font-medium", trend > 0 ? "text-[#788c5d]" : trend < 0 ? "text-[#c75050]" : "text-muted-foreground")}>
