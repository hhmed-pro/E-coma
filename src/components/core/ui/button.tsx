    ...
    "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
    {
        variants: {
            variant: {
                ...
                glass: "glass hover:bg-white/5 text-foreground shadow-sm",
                // Brand variant - Anthropic Orange accent
                brand: "bg-[hsl(var(--accent-orange))] text-white hover:bg-[hsl(var(--accent-orange)/0.9)] shadow-sm hover:shadow-[0_4px_20px_-4px_hsl(var(--accent-orange)/0.4)]",
                // Glow variant - subtle glow on hover
                glow: "bg-primary text-primary-foreground shadow-sm hover:shadow-[0_0_20px_-4px_hsl(var(--accent-orange)/0.5)] hover:bg-primary/95",
            },
            size: {
