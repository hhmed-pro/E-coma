                ...
                >
                    ...
                    <div className="flex items-center justify-between p-4 border-b">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 id="import-modal-title" className="text-lg font-semibold">Import Content</h2>
                        </div>
                        <Button variant="ghost" size="icon" onClick={handleClose} disabled={isProcessing} aria-label="Close">
                            <X className="h-4 w-4" />
                        </Button>
                    </div>
